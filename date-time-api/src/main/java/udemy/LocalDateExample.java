...
public class LocalDateExample {
    public static void main(String[] args) {
        ...
        System.out.println("With Temporal Adjusters lastDayOfMonth: " + localDate.with(TemporalAdjusters.lastDayOfMonth()));
        System.out.println("With Temporal Adjusters lastDayOfYear: " + localDate.with(TemporalAdjusters.lastDayOfYear()));
